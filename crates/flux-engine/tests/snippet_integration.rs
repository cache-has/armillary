...
fn snippet_with_udf_preserves_function_call() {
    ...
    let flux_engine::NodeKind::Transform(t) = &cleaned.kind else {
...
///
/// Wiring a live DataFusion executor from a plain flux-engine integration
/// test would require pulling in flux-datafusion + flux-connectors, which
...
/// helper exists.
#[test]
#[ignore = "requires flux-datafusion executor harness — see doc 29a test #14"]
